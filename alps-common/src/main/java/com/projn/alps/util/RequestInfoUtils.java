...
public final class RequestInfoUtils {
    ...
    public static HttpRequestInfo convertHttpRequestInfo(HttpServletRequest request,
        ...
        for (Field field : fields) {
            ...
            if (paramLocationType.equals(ParamLocationType.HEADER)) {
                ...
                if (file != null && field.getType().equals(MultipartFile.class)) {
    ...
    public static MsgRequestInfo convertMsgRequestInfo(String msgText, final Class<?> clazz)
        ...
        Map<String, Object> extendInfoMap = new HashMap<>(COLLECTION_INIT_SIZE);
        MsgRequestInfo msgRequestInfo = new MsgRequestInfo(null, paramObj, extendInfoMap);
        return msgRequestInfo;
    }

    /**
     * convert rpc request info
     *
     * @param msgText :
     * @param clazz   :
     ...
     * @throws Exception :
     */
    public static RpcRequestInfo convertRpcRequestInfo(String msgText, final Class<?> clazz)
            throws Exception {
        if (clazz == null) {
            throw new Exception("Invaild param.");
        }
        ...
        Map<String, Object> extendInfoMap = new HashMap<>(COLLECTION_INIT_SIZE);
        RpcRequestInfo rpcRequestInfo = new RpcRequestInfo(paramObj, extendInfoMap);
        return rpcRequestInfo;
    }
